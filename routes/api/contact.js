...
*/
  ...
  maria.query(
    `INSERT INTO ContactMsg(buildingId, userId, name, phone, email, company, date1, date2, budget, reason, enterpath, size, areaList, requests, added_date) VALUES (${contactPostQuery} , NOW());`,
    function (err) {
      if (!err) {
